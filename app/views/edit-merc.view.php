...
<body>
    ...
    <div class='container-edit'>
        ...
        <nav class="brand-selectors">
            <div class="brand-selector brand-selector-audi brand-selector-current">BMW</div>
                ...
                <?php foreach ($mercs as $merc) : ?>
                    ...
                    <ul class="edit-btns">
                        ...
                        <form class="delete-form" method="POST" action="/delete">
                            <input type="hidden" name="brand" value=" <?= $merc->brand ?> " />
                            <input type="hidden" name="id" value=" <?= $merc->id ?> " />
