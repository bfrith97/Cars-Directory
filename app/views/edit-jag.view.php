...
<body>
    ...
    <div class='container-edit'>
        ...
        <nav class="brand-selectors">
            <div class="brand-selector brand-selector-audi brand-selector-current">Jaguar</div>
                ...
                <?php foreach ($jags as $jag) : ?>
                    ...
                    <ul class="edit-btns">
                        ...
                        <form class="delete-form" method="POST" action="/delete">
                            <input type="hidden" name="brand" value=" <?= $jag->brand ?> " />
                            <input type="hidden" name="id" value=" <?= $jag->id ?> " />
